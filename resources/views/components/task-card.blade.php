...
<article
    ...
    <div class="flex items-start gap-3 sm:items-center sm:gap-4" x-data="{ goTo() { Livewire.navigate('{{ route('tasks.details', ['list' => $task->list_id, 'task' => $task->id]) }}') } }" x-on:click="goTo()">
