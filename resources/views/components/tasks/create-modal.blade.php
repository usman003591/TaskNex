                ...
                <form wire:submit="save" class="space-y-5 px-5 pb-5 sm:px-6 sm:pb-6">
                    ...
                    <div>
                        <label for="task-details"
                            ...
                            <span
                                class="font-normal normal-case tracking-normal text-[#666b85]">(optional)</span></label>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <div x-data="{ priorityDropdownOpen: false }" class="relative">
                                <button type="button" x-on:click.prevent="priorityDropdownOpen = !priorityDropdownOpen"
                                    ...
                                    <i class="fa-solid fa-chevron-down ml-1 text-[9px] text-[#666b85] transition-transform"
                                ...
                                <div x-show="priorityDropdownOpen" x-on:click.outside="priorityDropdownOpen = false"
                                    ...
                                    <button type="button" wire:click="$set('priority', null)"
                                        ...
                                        class="flex w-full items-center gap-2.5 px-3.5 py-[0.6rem] text-xs transition-colors duration-[180ms] motion-reduce:transition-none hover:bg-[#303249] cursor-pointer">
                                    ...
                                    <button type="button" wire:click="$set('priority', {{ $key }})"
                                        x-on:click="priorityDropdownOpen = false"
                                        class="flex w-full items-center gap-2.5 px-3.5 py-[0.6rem] text-xs transition-colors duration-[180ms] motion-reduce:transition-none hover:bg-[#303249] {{ $value['color'] }} cursor-pointer">
                            ...
                            {{-- Schedule date --}}
                            <div x-data="datepickerComponent('scheduledDate', 'scheduled_at')"
                                x-init="initDatepicker()">
                                @if(!$scheduled_at)
                                <button type="button" x-on:click.prevent="datepicker.show()"
                                    class="inline-flex min-h-8 items-center gap-2 py-1 px-3 text-[#85899f] text-[0.7rem] font-semibold bg-[#171925]/[0.62] border border-[#3d4058] rounded-[0.7rem] transition-colors duration-[180ms] motion-reduce:transition-none hover:text-[#e0e0dd] hover:bg-[#222438] hover:border-[#565a76] cursor-pointer">
                                    <i class="fa-regular fa-clock text-[13px] text-[#81c7ff]"></i>
                                    <span>Schedule</span>
                                </button>
                                @else
                                <span
                                    class="inline-flex min-h-8 items-center gap-2 py-1 px-3 text-[0.7rem] font-semibold bg-[#171925]/[0.62] border border-[#3d4058] rounded-[0.7rem] tn-create-modal__chip--active">
                                    ...
                                    <button type="button" wire:click="clearScheduledDate"
                                        class="ml-1 text-[#666b85] transition hover:text-[#f5f4ef]"
